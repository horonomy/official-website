<!-- horonom:generated -->
<!-- Source: horonomy/.github agents/skills/engineering-loop/SKILL.md. Provisional Codex projection shape — see agents/common/README.md. Do not hand-edit — rerun `python3 agents/common/project_skills.py`. -->
